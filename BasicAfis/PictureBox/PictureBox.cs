...
namespace PictureBoxCtrl
{
	...
	public class PictureBox : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
            ...
            this.PicBox.Location = new System.Drawing.Point(32, 23);
        ...
        */
		...
		private void InitCtrl ()
		{
            ...
            OuterPanel.MouseUp += new MouseEventHandler(PicBox_MouseUp);
            OuterPanel.MouseDown += new MouseEventHandler(PicBox_MouseDown);
            OuterPanel.MouseMove += new MouseEventHandler(PicBox_MouseMove);
		...
		private void ZoomIn() 
		{
			if ( ( PicBox.Width < ( MINMAX * OuterPanel.Width ) ) && ( PicBox.Height < ( MINMAX * OuterPanel.Height ) ) )
			{
		...
		{
			if ( ( PicBox.Width > ( OuterPanel.Width / MINMAX ) ) && ( PicBox.Height > ( OuterPanel.Height / MINMAX ) ) )
			{
				PicBox.SizeMode = PictureBoxSizeMode.StretchImage; 
				PicBox.Width = Convert.ToInt32 ( PicBox.Width / ZOOMFACTOR );
				PicBox.Height = Convert.ToInt32 ( PicBox.Height / ZOOMFACTOR );
        ...
        private void PicBox_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            //toolTip1.Show(Convert.ToString(xCoordinate) + " x " + Convert.ToString(yCoordinate), pictureBox12, e.X + 10, e.Y + 10, 1000);
        ...
        private void PicBox_MouseMove(object sender, MouseEventArgs e)
        {
            if (_tracking &&
             ...
             PicBox.Height > this.ClientSize.Height))
            {
